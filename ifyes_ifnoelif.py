...
# to determine whether machines could exhibit intelligent behavior. A user sits at a computer and 
# does the same text chat with a human sitting at a computer and a computer operating by itself. 
...
num1 = input("What is your problem? ")
num2 = input("Have you had this problem before (yes or no)? ")
if num2 == 'yes':
